...
def _set_envs_and_config(server_args: ServerArgs):
    ...
    if server_args.custom_sigquit_handler is None:
        ...
        try:
            ...
            logger.warning("Could not register launch phase SIGQUIT handler in this environment.")
    else:
        ...
        try:
            ...
            logger.warning("Could not register custom SIGQUIT handler in this environment.")
